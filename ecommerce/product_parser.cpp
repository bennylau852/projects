			      ...
			      int& lineno)
{
  ...
  return parseSpecificProduct(category, is, error, errorMsg, lineno); //Depending on which product category the product belongs to
}
...
Product* ProductBookParser::makeProduct() {
  ...
  Product* book = new Book(category_, prodName_, isbn_, author_, price_, qty_); //Passes in required arguments to make a Book object
...
Product* ProductClothingParser::makeProduct() {
  ...
  Product* clothing = new Clothing(category_, prodName_, size_, brand_, price_, qty_);
...
Product* ProductMovieParser::makeProduct() {
  ...
  Product* movie = new Movie(category_, prodName_, genre_, rating_, price_, qty_);
